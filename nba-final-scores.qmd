---
title: "NBA Final Scores"
"author": "Diya Sharma"
format: html
---

This notebook reads the NBA final scores from `Games.csv` and displays a visualization of every unique final score.
...
plot <- plot_ly() %>%
  add_trace(
    ...
    marker = list(size = 6, opacity = 0.85, line = list(width = 0.5, color = "#FFFFFF")),
